        ...
        <?php
            ...
            echo Nav::widget([
                ...
                'items' => [
                    ...
                    ['label' => 'My Courses', 'url' => ['/site/courses'], 'visible' => Yii::$app->user->can('student')],
                    ['label' => 'Administration', 'url' => ['/admin'], 'visible' => Yii::$app->user->can('teacher')],
                    ['label' => 'IELTS', 'url' => ['/site/ielts']],
